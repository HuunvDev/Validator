        ...
        formElement.onsubmit = function(e){
            ...
            if(isFormValid){
             if( typeof options.onSubmit ==='function'){
                var enableInputs = formElement.querySelectorAll('[name]:not([disabled])');//lấy ra tất cả các phần tử có attribute là name và ko lấy các phần tử  bị disabled( có nghĩa là bị ẩn đi
                options.onSubmit({
                    name:,
                    email:,
                    password:,
