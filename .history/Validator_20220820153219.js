            ...
            if(errorMessage) break;
               ...
               // var errorMessage = rules.test(inputElement.value);
                ...
                if(errorMessage){
                 ...
                 errorElement.getParent(inputElement, options.formGroupSelector).classList.add('invalid');
                }else{
                 errorElement.innerText = " ";
                 errorElement.getParent(inputElement, options.formGroupSelector).classList.remove('invalid');
                }
